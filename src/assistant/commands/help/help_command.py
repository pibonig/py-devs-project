...
class HelpCommand:
    ...
    def execute(self):
        commands_info = [
            ...
            [CloseCommand.name[0], CloseCommand.signature, CloseCommand.description],
            [CloseCommand.name[1], CloseCommand.signature, CloseCommand.description],
            ...
            [ChangeTagCommand.name, ChangeTagCommand.signature, ChangeTagCommand.description],
